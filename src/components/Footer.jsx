...
const Footer = () => {
    return (
        ...
        <footer className="bg-gray-100 mt-6" >
            ...
            <hr className=" w-11/12 md:w-4/6 mx-auto border-t border-gray-300 my-4"></hr>
            ...
            <div className=" relative block md:flex justify-between px-4 md:px-64 text-gray-500 text-xs py-8 md:py-4 space-y-2 items-center" >
                <h2>Copyright © 2025 Apple Inc. All rights reserved.</h2>
                <ul className=" flex items-center justify-center md:mr-72 font-semibold gap-2 flex-wrap">
                    <li><a href="" className="hover:underline">Privacy pollicy |</a></li>
