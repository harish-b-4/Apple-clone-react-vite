...
const Button = () => {
    ...
    return (
        <div className="w-full mt-3">
            ...
            <div className="flex overflow-x-scroll snap-x snap-mandatory w-full h-screen scroll-smooth hidden md:flex" id="scrollbar">
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory w-full scroll-smooth md:hidden gap-x-6 px-6 pb-0 mb-0 !h-auto !min-h-0 !max-h-none" id="scrollbar">
                {buttonsMobileData.map((item, index) => (
                    <div key={index} className="relative flex-shrink-0 w-[75%] h-[350px] snap-center flex justify-center items-center">
                        <div className="relative bg-white shadow-lg overflow-hidden w-full h-full flex flex-col justify-end items-center">
                            <img src={item.img} alt={`ButtonMobile${index + 1}`} className="absolute w-full h-full object-cover"/>
                            ...
                            <div className="relative text-center text-white px-6 pb-3">
                                ...
                                <button className="bg-white text-black px-6 py-2 rounded-full font-medium">Stream now</button>
                            </div>
                        </div>
                    </div>
                ))}
